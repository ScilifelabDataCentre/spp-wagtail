    ...
    def clean(self) -> None:
        ...
        Validation rules:
            - If a main menu item does not have `has_submenu` enabled,
              it must include a top-level page reference.
                    ...
                    if form.cleaned_data.get("has_submenu"):
                        ...
                        if len(form.formsets.get("sub_menu_items", [])) == 0:
                            ...
                            for sub_form in form.formsets["sub_menu_items"].forms:
                                if sub_form.is_valid() and not sub_form.cleaned_data.get("page"):
                                    sub_form.add_error(
                                        "page",
...
class NavigationMenu(ClusterableModel):
    ...
    panels = [
        ...
        FieldPanel("slug", help_text="Autogenerated from given title, but can be modified."),
...
class NavigationMainMenu(MenuItem, ClusterableModel):
    ...
    panels = MenuItem.panels + [
        FieldPanel(
            "has_submenu",
            help_text="Enable to use sub menu items, otherwise they are ignored.",
        ),
